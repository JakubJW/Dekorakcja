...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_carousel_relation_to" AS ENUM('products', 'rentables');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_relation_to" AS ENUM('products', 'rentables');
  ...
  CREATE TYPE "public"."enum_rentables_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_rentables_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_rentables_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum_rentables_blocks_content_columns_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_rentables_blocks_content_columns_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TABLE "inquiries" (
  	...
  	"status" "enum_inquiries_status" DEFAULT 'pending',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE "rentables_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "rentables_blocks_cta_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_rentables_blocks_cta_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL,
  	"link_appearance" "enum_rentables_blocks_cta_links_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE "rentables_blocks_cta" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "rentables_blocks_content_columns" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"size" "enum_rentables_blocks_content_columns_size" DEFAULT 'oneThird',
  	"rich_text" jsonb,
  	"enable_link" boolean,
  	"link_type" "enum_rentables_blocks_content_columns_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_rentables_blocks_content_columns_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE "rentables_blocks_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "rentables_blocks_media_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "rentables_gallery" ADD CONSTRAINT "rentables_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "rentables_gallery" ADD CONSTRAINT "rentables_gallery_variant_option_id_variant_options_id_fk" FOREIGN KEY ("variant_option_id") REFERENCES "public"."variant_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "rentables_gallery" ADD CONSTRAINT "rentables_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_blocks_cta_links" ADD CONSTRAINT "rentables_blocks_cta_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables_blocks_cta"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_blocks_cta" ADD CONSTRAINT "rentables_blocks_cta_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_blocks_content_columns" ADD CONSTRAINT "rentables_blocks_content_columns_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables_blocks_content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_blocks_content" ADD CONSTRAINT "rentables_blocks_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_blocks_media_block" ADD CONSTRAINT "rentables_blocks_media_block_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "rentables_blocks_media_block" ADD CONSTRAINT "rentables_blocks_media_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables" ADD CONSTRAINT "rentables_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "rentables_rels" ADD CONSTRAINT "rentables_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_rels" ADD CONSTRAINT "rentables_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_rels" ADD CONSTRAINT "rentables_rels_products_fk" FOREIGN KEY ("products_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "rentables_rels" ADD CONSTRAINT "rentables_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_rentables_fk" FOREIGN KEY ("rentables_id") REFERENCES "public"."rentables"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "rentables_gallery_order_idx" ON "rentables_gallery" USING btree ("_order");
  CREATE INDEX "rentables_gallery_parent_id_idx" ON "rentables_gallery" USING btree ("_parent_id");
  CREATE INDEX "rentables_gallery_image_idx" ON "rentables_gallery" USING btree ("image_id");
  CREATE INDEX "rentables_gallery_variant_option_idx" ON "rentables_gallery" USING btree ("variant_option_id");
  CREATE INDEX "rentables_blocks_cta_links_order_idx" ON "rentables_blocks_cta_links" USING btree ("_order");
  CREATE INDEX "rentables_blocks_cta_links_parent_id_idx" ON "rentables_blocks_cta_links" USING btree ("_parent_id");
  CREATE INDEX "rentables_blocks_cta_order_idx" ON "rentables_blocks_cta" USING btree ("_order");
  CREATE INDEX "rentables_blocks_cta_parent_id_idx" ON "rentables_blocks_cta" USING btree ("_parent_id");
  CREATE INDEX "rentables_blocks_cta_path_idx" ON "rentables_blocks_cta" USING btree ("_path");
  CREATE INDEX "rentables_blocks_content_columns_order_idx" ON "rentables_blocks_content_columns" USING btree ("_order");
  CREATE INDEX "rentables_blocks_content_columns_parent_id_idx" ON "rentables_blocks_content_columns" USING btree ("_parent_id");
  CREATE INDEX "rentables_blocks_content_order_idx" ON "rentables_blocks_content" USING btree ("_order");
  CREATE INDEX "rentables_blocks_content_parent_id_idx" ON "rentables_blocks_content" USING btree ("_parent_id");
  CREATE INDEX "rentables_blocks_content_path_idx" ON "rentables_blocks_content" USING btree ("_path");
  CREATE INDEX "rentables_blocks_media_block_order_idx" ON "rentables_blocks_media_block" USING btree ("_order");
  CREATE INDEX "rentables_blocks_media_block_parent_id_idx" ON "rentables_blocks_media_block" USING btree ("_parent_id");
  CREATE INDEX "rentables_blocks_media_block_path_idx" ON "rentables_blocks_media_block" USING btree ("_path");
  CREATE INDEX "rentables_blocks_media_block_media_idx" ON "rentables_blocks_media_block" USING btree ("media_id");
  CREATE INDEX "rentables_meta_meta_image_idx" ON "rentables" USING btree ("meta_image_id");
  CREATE UNIQUE INDEX "rentables_slug_idx" ON "rentables" USING btree ("slug");
  CREATE INDEX "rentables_updated_at_idx" ON "rentables" USING btree ("updated_at");
  CREATE INDEX "rentables_created_at_idx" ON "rentables" USING btree ("created_at");
  CREATE INDEX "rentables_rels_order_idx" ON "rentables_rels" USING btree ("order");
  CREATE INDEX "rentables_rels_parent_idx" ON "rentables_rels" USING btree ("parent_id");
  CREATE INDEX "rentables_rels_path_idx" ON "rentables_rels" USING btree ("path");
  CREATE INDEX "rentables_rels_pages_id_idx" ON "rentables_rels" USING btree ("pages_id");
  CREATE INDEX "rentables_rels_products_id_idx" ON "rentables_rels" USING btree ("products_id");
  CREATE INDEX "rentables_rels_categories_id_idx" ON "rentables_rels" USING btree ("categories_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_rentables_id_idx" ON "payload_locked_documents_rels" USING btree ("rentables_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "rentables_gallery" CASCADE;
  DROP TABLE "rentables_blocks_cta_links" CASCADE;
  DROP TABLE "rentables_blocks_cta" CASCADE;
  DROP TABLE "rentables_blocks_content_columns" CASCADE;
  DROP TABLE "rentables_blocks_content" CASCADE;
  DROP TABLE "rentables_blocks_media_block" CASCADE;
  DROP TABLE "rentables" CASCADE;
  DROP TABLE "rentables_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_rentables_blocks_cta_links_link_type";
  DROP TYPE "public"."enum_rentables_blocks_cta_links_link_appearance";
  DROP TYPE "public"."enum_rentables_blocks_content_columns_size";
  DROP TYPE "public"."enum_rentables_blocks_content_columns_link_type";
  DROP TYPE "public"."enum_rentables_blocks_content_columns_link_appearance";
